...
def training_model(selected_ticker,SHARE_PRICES_FILE,COMPANY_INFO_FILE):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train a stock prediction model for a given ticker.")
    parser.add_argument("ticker", type=str, help="Ticker symbol of the company to train the model for.")
    ...
    training_model(selected_ticker,SHARE_PRICES_FILE,COMPANY_INFO_FILE)
